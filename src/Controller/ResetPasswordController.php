...
class ResetPasswordController extends AbstractController
{
    ...
    public function reset(Request $request, UserPasswordEncoderInterface $passwordEncoder, string $token = null): Response
    {
        ...
        if (null === $token) {
            $message = $this->translator->trans('No reset password token found in the URL or in the session.');
        ...
        try {
            ...
            $message = $this->translator->trans('There was a problem validating your reset request - %s');
